...
class Home extends StatelessWidget// StateWidget을 상속받은 클래스로, 홈 화면 구현
    {
  @override
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) =>
                      Padding(
                        ...
                        child: HomeList_Type(home_picture[index]['imagePath'],
                            home_picture[index]['placeName'],
                            home_picture[index]['placeSummary'],
                            context ),
                      )
              ),
            ),
  ...
  Widget HomeList_Type(String imagePath, String placeName,
      String touristPlaceCount, context)//홈(관광지) 목록 아이템을 구성하는 위젯을 반환
  {
    return GestureDetector//클릭할 때의 동작을 정의
      (
      onTap: () => {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => HomeDetail(imagePath)))
      },
